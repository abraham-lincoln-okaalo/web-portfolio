        ...
        if(event.target.classList.contains('link-item')){
           // make sure event.target.hash has a value before overriding default behaviour
            if(event.target.hash !==""){
                ...
                // if clicked 'link-item' is within the navigation menu
...
(() =>{
    ...
    tabsContainer.addEventListener("click", (event)=>{
        /* if event.target contains 'tab-item' class and does not contain 'active' class */
...
(() =>{
    ...
    portfolioItems = document.querySelectorAll(".portfolio-item"), popup = document.querySelector(".portfolio-popup"), 
